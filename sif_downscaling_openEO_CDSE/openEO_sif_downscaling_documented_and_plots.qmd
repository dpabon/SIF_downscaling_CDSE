...
This section is temporal (I hope...) until openEO team solve the upsampling issue. For details see [CDSE discusion forum](https://forum.dataspace.copernicus.eu/t/how-to-spatial-upsampling-when-using-resample-cube-spatial/4358/6)
...
Originally OTCI and IWV products are 300 meters resolution, as Sentinel-3 LST product is at 1 km (@tbl-predictors) we need to resample these products:
...
To downscale SIF we will use the 