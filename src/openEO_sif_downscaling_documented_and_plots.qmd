...
cube_SIF_original = connection.load_stac(
    "https://raw.githubusercontent.com/dpabon/SIF_downscaling_CDSE/refs/heads/indonesia_downscaling_example/data/2023-07-SIF/collection.json",
    bands=["SIF"],
...
parameters_cube_low = dataset_SIF_low.apply_neighborhood(
    process=my_udf,
    size=[
        {"dimension": "x", "value": 15, "unit": "px"},
        {"dimension": "y", "value": 15, "unit": "px"},
    ],
    overlap=[
