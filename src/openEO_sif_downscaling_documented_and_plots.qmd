...
cube_ndvi_local = rio.open_rasterio(
    filename="data/cube_NDVI_median.tif", mask_and_scale=True
)
...
cube_NDVI_median_low = cube_NDVI_median_low * 0.004 - 0.08
...
dataset_SIF_low.execute_batch(
    outputfile="data/sif_predictors_cube_low.tif",
    job_options={
...
```{python}
print(dataset_sif_low_local["NDVI"])
dataset_sif_low_local["NDVI"] = dataset_sif_low_local["NDVI"] * 0.004 - 0.08
```
