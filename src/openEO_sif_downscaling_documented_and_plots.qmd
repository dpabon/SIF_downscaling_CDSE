...
temporal_extent_prototype = ["2023-07-24", "2023-07-31"]
```
...
cube_SIF_original_median = connection.load_stac(
    "https://raw.githubusercontent.com/dpabon/SIF_downscaling_CDSE/refs/heads/indonesia_downscaling_example/data/2023-07-SIF/SIF_20230729.json",
    bands=["SIF"],
...
job_options = {
    ...
    "soft-errors": 0.05,  # Tolerate up to 5% failure
    "executor-cores": 1,
    "task-cpus": 1,
    "logging-threshold": "debug"
}
parameters_cube_low_rename.execute_batch(outputfile="data/results_parameters_optim_low_resolution.tif", job_options=job_options)
...
sif_downscaled_resampled_local = sif_downscaled_resampled_local.isel(x = range(100), y = range(0,100))
